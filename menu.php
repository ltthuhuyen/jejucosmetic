        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(253, 215, 226);">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-1" type="search" placeholder="Tìm kiếm" aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-1" type="submit">Tìm kiếm</button>
              </form>
              <!-- <ul class="navbar-nav ">
              <li class="nav-item">
                    <button type="button" class="btn btn-pink text-pink m-3">
                        <a href="./khachhang/login.php" class="text-pink btn-pink" style="text-decoration: none;">Đăng nhập</a>
                  </button>
                </li>
                <li class="nav-item">
