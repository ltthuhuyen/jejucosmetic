...
<body >
    <div class="container-fluid p-0">
      <div class="row">
          ...
          <nav class="navbar navbar-expand-lg navbar-expand-sm-3 navbar-expand-md-6 navbar-light " style="background-color: rgb(253, 215, 226);">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-0" type="search" placeholder="Tìm kiếm" aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-0 " type="submit">Tìm kiếm</button>
              </form>
              <ul class="navbar-nav ">
                <li class="nav-item  ">
                  <a class="nav-link" name ='btn-login' href="./khachhang/login.php">
                    <button class="btn btn-pink text-pink mr-sm-0" style="border: 1px solid pink"  >
                      Đăng nhập
                    </button>
                  </a>
                </li>
        ...
        <div class="row">
          ...
          ?>
          <div class="col-sm-3 col-md-6 text-center mx-auto">
