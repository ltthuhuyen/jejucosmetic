<?php
    ...
    $count_hanghoa= mysqli_query($connect, "SELECT  count(*) FROM HangHoa");
               ...
               <thead>
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td><img src="../../image/<?php echo $row['Hinh'] ?>" alt="" width="100px"></td>
                        <td ><?php echo number_format  ($row['Gia'],0,",",".") ?></td>
                        <td >
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <a href = './xem.php?MHH=<?php echo $row['MHH'] ?>' class="btn btn-light" ><i class="far fa-eye"></i></a>
                                <a href = './sua.php?MHH=<?php echo $row['MHH'] ?>' class="btn btn-light" ><i class="far fa-edit"></i></a>
                                <a href = './xoa.php?MHH=<?php echo $row['MHH'] ?>' class="btn btn-outline-danger" ><i class="far fa-trash-alt"></i></a>
                            </div>
                        </td>
                    </tr>  
                    <?php
